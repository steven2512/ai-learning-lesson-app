...
class ComputerSeeZeroOne extends StatefulWidget {
  /// Fired AFTER COMPLETE (plus kContinueDelayMs) to unlock Continue.
  final VoidCallback onStarted;

  const ComputerSeeZeroOne({super.key, required this.onStarted});

  @override
  State<ComputerSeeZeroOne> createState() => _ComputerSeeZeroOneState();
}

class _ComputerSeeZeroOneState extends State<ComputerSeeZeroOne> {
  bool _started = false;
