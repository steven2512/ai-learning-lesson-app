...
// ✅ Wrap-up as a centered Dialogue. 3 short pages, tuned fonts to avoid wrapping on page 1.
...
class WrapUpDialogue extends StatelessWidget {
  ...
  const WrapUpDialogue({super.key, this.onFinished});
                    ...
                    children: [
                      LessonText.sentence([
                        ...
                        LessonText.word("AI", _aiPink,
                            fontSize: _dialogueSize,
                            fontWeight: FontWeight.w900),
                        LessonText.word("!", _aiPink, fontSize: _dialogueSize),
                      ]),
                    ],
                  ),
