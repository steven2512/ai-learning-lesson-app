  ...
  Widget build(BuildContext context) {
    final List<Widget> successMsg = [
      ...
      LessonText.sentence([
        ...
        LessonText.word("to get next number", Colors.black87,
      ...
      LessonText.sentence([
        LessonText.word("This", Colors.black87,
            fontSize: _correctTextSize, fontWeight: FontWeight.w600),
        LessonText.word("is", Colors.black87, fontSize: _correctTextSize),
        LessonText.word("another", Colors.black87,
            fontSize: _correctTextSize, fontWeight: FontWeight.w600),
        LessonText.word("example", Colors.black87, fontSize: _correctTextSize),
        LessonText.word("of", Colors.black87, fontSize: _correctTextSize),
        LessonText.word("a", Colors.black87, fontSize: _correctTextSize),
        LessonText.word("prediction", const Color.fromARGB(255, 215, 0, 0),
            fontSize: _correctTextSize,
            italic: true,
            fontWeight: FontWeight.bold),
        LessonText.word("task", const Color.fromARGB(255, 215, 0, 0),
            fontSize: _correctTextSize),
        LessonText.word("that", Colors.black87,
            fontSize: _correctTextSize, fontWeight: FontWeight.w600),
        LessonText.word("AI", Colors.black87, fontSize: _correctTextSize),
        ...
        LessonText.word("really", Colors.black87,
            fontSize: _correctTextSize, fontWeight: FontWeight.w900),
        LessonText.word("good", Colors.black87,
            fontSize: _correctTextSize, fontWeight: FontWeight.w900),
