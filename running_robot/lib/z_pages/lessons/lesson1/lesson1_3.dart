...
class LessonStepTwo extends StatefulWidget {
  ...
  @override
  State<LessonStepTwo> createState() => LessonStepOneState();
}

class LessonStepOneState extends State<LessonStepTwo> {
  bool _answeredCorrect = false;
  bool _triedWrong = false;

  _QuizItem get current => LessonStepTwo._quizItems[widget.quizIndex];
  ...
  Widget build(BuildContext context) {
    final List<Widget> successMsg =
        (widget.quizIndex < LessonStepTwo.successMessages.length)
            ? LessonStepTwo.successMessages[widget.quizIndex]
            : [
                LessonText.sentence([
                  LessonText.word("Correct", Colors.green.shade800,
                      fontSize: correctTextSize),
